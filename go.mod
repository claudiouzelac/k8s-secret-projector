module github.com/tumblr/k8s-secret-projector
...
require (
	...
	k8s.io/kubernetes v0.0.0-20171107192125-454074d23034
)
...
require (
	...
	github.com/spacemonkeygo/openssl v0.0.0-20180727012650-5da517866c3d // indirect
